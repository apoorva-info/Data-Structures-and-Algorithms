...
""" 
Why Hashing?
If there are q inputs and we need to check the frequency of each input, then the time complexity will 
be O( n * q ).
We know that,
10^8 operations ----> 1 s
Suppose, we have a many inputs: 10^10
10^10 operations ----> (1 / 10^8) * 10^10 ----> 100 s (Too much time!)
"""